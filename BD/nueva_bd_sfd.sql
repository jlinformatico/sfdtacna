...
--
-- Servidor: localhost
-- Tiempo de generación: 18-09-2013 a las 05:17:56
...
CREATE TABLE IF NOT EXISTS `inscriptos` (
  ...
  `asistencia` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 -> no asistio1->asistio al evento',
...
(1, 'admin', '3a37d322ba129a4ed448a288ef2e71b53e71ec79', NULL);
